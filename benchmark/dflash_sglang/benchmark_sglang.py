...
from dataset_loader import load_and_process_dataset
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.8,
        help="Confidence threshold for recycling draft tokens.",
    )
    ...
    md_lines.append(f"- speculative_dflash_recycle: `{bool(args.speculative_dflash_recycle)}`")
    md_lines.append(f"- speculative_dflash_recycle_confidence: `{args.speculative_dflash_recycle_confidence if args.speculative_dflash_recycle else None}`")
